        ...
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            <li class="mb-2 bg-white rounded cursor-pointer">
                <a href="{{ route('dashboard.index') }}"
                    ...
                    {{ in_array(Route::currentRouteName(), ['dashboard.index', 'chart.dialyGuest', 'chart.dialyIncome', 'dashboard.myReservation']) ? 'active' : '' }}
                    "
            ...
            @if (auth()->user()->role == 'Super' || auth()->user()->role == 'Admin')
                ...
                <li class="mb-2 bg-white rounded cursor-pointer">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="{{ route('menu.index') }}">Food Menu</a></li>
                    </ul>
                </li>
                <li class="mb-2 bg-white rounded cursor-pointer">
