                    ...
                    <form class="row g-3" method="POST"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" class="form-control @error('phone_number') is-invalid @enderror" id=" phone_number"
                                name="phone_number" value="{{ $customer->user->phone_number }}" disabled>
                            @error('phone_number')
                                <div class="text-danger mt-1">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-12">
                            <label for="birthdate" class="form-label">ID Number</label>
                            <input type="text" class="form-control @error('birthdate') is-invalid @enderror" id="birthdate"
                                name="birthdate" value="{{ $customer->birthdate }}" disabled>
                            @error('birthdate')
                                <div class="text-danger mt-1">
                                    {{ $message }}
                                </div>
