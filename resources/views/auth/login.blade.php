                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-label-group">
                                        <input type="text" id="email_or_phone" name="email_or_phone" class="form-control @error('email_or_phone') is-invalid @enderror"
                                            placeholder="Email or Phone Number" value="{{ old('email_or_phone') }}" required autofocus>
