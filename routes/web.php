...
use App\Http\Controllers\Admin\MenuControllerz;
...
Route::group(['middleware' => ['auth', 'checkRole:Super,Admin']], function () {
    ...
    Route::resource('menu', MenuControllerz::class);
    ...
    Route::get('/ticket/{customer}/{room}/{query}', [CustomerController::class, 'ticket'])->name('ticket.index');
    Route::get('/order/{customer}/{room}/{query}', [CustomerController::class, 'order'])->name('order.index');
    ...
    //Route::get('/chart/dialyGuestPerMonth', 'ChartController@dialyGuestPerMonth')->name('chart.dialyGuestPerMonth');

    Route::get('/get-income-chart-data', [ChartController::class, 'incomePerMonth']);
    Route::get('/get-daily-income/{year}/{month}/{day}', [ChartController::class, 'dailyIncome'])->name('chart.dialyIncome');
});
...
Route::group(['middleware' => ['auth', 'checkRole:Super,Admin,Customer']], function () {
    ...
    Route::get('/order/{customer}/{room}', [MenuController::class,'index'])->name('order.menu');
    Route::post('/order-placed/{customer}/{room}', [OrderController::class, 'store'])->name('order.store');

    Route::get('/roomservice/{customer}/{room}', [CustomerController::class, 'editRoomStatus'])->name('roomservice.index');

    Route::put('/room-service/{customer}/{room}', [CustomerController::class, 'roomService'])->name('room.service');

    Route::get('/dashboard', [DashboardController::class, 'index'])->name('dashboard.index');
   // Route::get('/dashboard/my-reservation', [DashboardController::class, 'myReservation'])->name('dashboard.myReservation');
